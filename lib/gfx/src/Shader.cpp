...
namespace gfx
{
    Shader::Shader(std::string vertexShaderPath, std::string fragmentShaderPath, gsl::span<const VertexAttr> attributes)
    {
        using namespace std;
        cout << "vs: " << vertexShaderPath << endl;
        cout << "fs: " << fragmentShaderPath << endl;
